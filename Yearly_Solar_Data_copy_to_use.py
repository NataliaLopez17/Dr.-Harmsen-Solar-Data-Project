"""
    [Created on March 27, 2022; Used on September 16, 2022]
...
def request_builder(start=2021, end=2021, interval=15, email={default_email}):
    """
    ...
    The default for this parameter is 2021 as it is the minimum year available for data download.]. 
    Defaults to 2021.
