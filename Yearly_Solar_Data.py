...
def download_zip(download_url_v, dest={destination}):
...
if __name__ == "__main__":
    ...
    if start_year.isdigit() and end_year.isdigit() and interval.isdigit():
        if int(start_year) >= 2018:
            ...
            if response_v.status_code == 200: #and response_ne.status_code == 200 \
                ...
                TimeoutHTTPAdapter(download_url_v)
                download_zip(download_url_v,destination)
        else:
